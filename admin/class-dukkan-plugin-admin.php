	...
	public function enqueue_scripts($hook_suffix) {
		...
		wp_localize_script($this->plugin_name, 'wpldp_ajax', [
			...
			'dp_i18n' => [
				...
				'enabled'            => __( 'Rule enabled.', 'dukkan-plugin' ),
				'disabled'           => __( 'Rule disabled.', 'dukkan-plugin' ),
				'name_required'      => __( 'Rule name is required.', 'dukkan-plugin' ),
				'value_required'     => __( 'Discount value must be greater than zero.', 'dukkan-plugin' ),
				'categories_required'=> __( 'Please select at least one category.', 'dukkan-plugin' ),
				'products_required'  => __( 'Please select at least one product.', 'dukkan-plugin' ),
				'edit'               => __( 'Edit', 'dukkan-plugin' ),
				'duplicate'          => __( 'Duplicate', 'dukkan-plugin' ),
				'delete'             => __( 'Delete', 'dukkan-plugin' ),
				'delete_btn'         => __( 'Delete', 'dukkan-plugin' ),
				'cancel'             => __( 'Cancel', 'dukkan-plugin' ),
				'off'                => __( 'off', 'dukkan-plugin' ),
				'buy_x_get_y'        => __( 'Buy X Get Y', 'dukkan-plugin' ),
				'all_products'       => __( 'All Products', 'dukkan-plugin' ),
				'categories'         => __( 'Categories', 'dukkan-plugin' ),
				'products_label'     => __( 'Products', 'dukkan-plugin' ),
				'value_hint_percent' => __( 'Enter the discount percentage (e.g. 20 for 20% off).', 'dukkan-plugin' ),
				'value_hint_fixed'   => __( 'Enter the fixed discount amount.', 'dukkan-plugin' ),
				'value_hint_buy'     => __( 'Enter the discount amount for Buy X Get Y offers.', 'dukkan-plugin' ),
				'select_categories'  => __( 'Search categories…', 'dukkan-plugin' ),
				'search_products'    => __( 'Search products…', 'dukkan-plugin' ),
			],
		]);
